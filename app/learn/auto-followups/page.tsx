      ...
      <div style={{ maxWidth: '1100px', margin: '0 auto' }}>
          ...
          <div style={{
            ...
            <div>
              ...
              <p style={{
                ...
                Instant SMS sequences that close
              </p>
            </div>
          </div>
        </div>
        ...
        <div style={{
          ...
          <div>
            ...
            <p style={{
              ...
              Your follow-up system that responds to leads within seconds, not hours. 
              Multi-touch SMS sequences automatically nurture every lead from cold inquiry 
              to closed deal—all while you sleep.
            </p>
        ...
        <div style={{
          ...
          <p style={{
            ...
            Set up your automated SMS sequences and never let a lead slip away.
          </p>
          <Link
            href="/intake"
            style={{
